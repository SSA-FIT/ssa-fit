# SSAFIT
<img src="./img/main.png" alt="main" width="1000px" />
<br/>
...
### 신체 정보 기반 운동 추천
<img src="./img/exercise1.png" alt="신체 정보 기반 운동 추천" width="1000px" />

### 유사도 기반 운동 추천
<img src="./img/exercise2.png" alt="유사도 기반 운동 추천" width="1000px" />

### YouTube API 영상
<img src="./img/youtube.png" alt="youtube" width="1000px" />

### 즐겨찾기 기능
<img src="./img/bookmark.png" alt="즐겨찾기" width="1000px" />

### 운동 이력 조회
<img src="./img/history.png" alt="운동이력조회" width="1000px" />
...
|                              개체-관계 모델(ERD)                               |
| :----------------------------------------------------------------------------: |
| <img src="./img/ERD.png" alt="개체-관계 모델(ERD)" width="1000px" /> |
...
| 조은솔 |      Back-end      | - DB 설계<br /> - 추천 알고리즘 구현<br /> - 데이터 전처리, 더미 데이터 제작<br /> - Spring Boot RESTful API 작성<br /> &nbsp;&nbsp;&nbsp;&nbsp;- 즐겨찾기, 유사도 기반 추천 운동 조회<br />&nbsp;&nbsp;&nbsp;&nbsp;- 운동 이력 저장<br /> - Back-end Reader
...
spring:
  ...
  datasource:
    url: jdbc:mariadb://[도메인]:[port]/ssafit_test?serverTimezone=Asia/Seoul&characterEncoding=UTF-8
