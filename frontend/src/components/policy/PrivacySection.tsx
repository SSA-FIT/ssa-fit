...
const PRIVACY_STORE_CONTENTS = [
  ...
  {
    id: 2,
    content: '필수항목 : 이메일, 비밀번호, 신체정보, 서비스 이용 기록, 쿠키',
  },
  {
    id: 3,
    content: '선택항목 : 닉네임',
...
const PrivacySection: React.FC = () => {
  return (
    <Container>
      <Wrapper>
        <Head>싸핏 개인정보 취급방침</Head>
        <PrivacyPreDescriptionWrapper>
          <DescriptionList>
            <DescriptionItem>
              [SSA-FIT]('{process.env.REACT_APP_CLIENT_URL}'이하 '싸핏')은(는)
            ...
            <DescriptionItem>
              본 개인정보 처리 방침은 '싸핏'의 개인 이용약관 및 기업 이용약관
              제2조에 정의된 “서비스”에 적용되며 아래의 내용을 포함합니다.
            </DescriptionItem>
          </DescriptionList>
          <PrivacyContentsList>
        ...
        <PrivacyList>
          <PrivacyItem>
            ...
            <DescriptionList>
              <DescriptionItem>
                싸핏는 필요한 한도 내에서 최소한의 개인정보를 수집하며, 수집한
          ...
          <PrivacyItem>
            ...
            <DescriptionList>
              <DescriptionItem>
                싸핏는 법령에 따른 개인정보 보유·이용 기간 또는 정보주체로부터
          ...
          <PrivacyItem>
            ...
            <DescriptionDetailList>
              <DescriptionDetailItem>
                1. 정보주체는 싸핏에 대해 언제든지 개인정보
                열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
              </DescriptionDetailItem>
              <DescriptionDetailItem>
                2. 제1항에 따른 권리 행사는 싸핏에 대해 「개인정보 보호법」
                시행령 제41조 제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
                통하여 하실 수 있으며 싸핏는 이에 대해 지체 없이 조치하겠습니다.
              </DescriptionDetailItem>
              <DescriptionDetailItem>
              ...
              <DescriptionDetailItem>
                6. 싸핏는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
          ...
          <PrivacyItem>
            ...
            <DescriptionList>
              <DescriptionItem>
                싸핏는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
                불필요하게 되었을 때에는 바로 해당 개인정보를 파기합니다.
                정보주체로부터 동의받은 개인정보 보유기간이 지나거나 처리목적이
            ...
            <DescriptionDetailList>
              <DescriptionDetailItemWrapper>
                ...
                <DescriptionDetailItem>
                  싸핏는 파기 사유가 발생한 개인정보를 선정하고 파기합니다.
                </DescriptionDetailItem>
              </DescriptionDetailItemWrapper>
              <DescriptionDetailItemWrapper>
                <DescriptionDetailItemHead>
          ...
          <PrivacyItem>
            ...
            <DescriptionList>
              <DescriptionItem>
                싸핏 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
                있습니다.
              </DescriptionItem>
            </DescriptionList>
            <DescriptionDetailList>
          ...
          <PrivacyItem>
            ...
            <DescriptionList>
              <DescriptionItem>
                싸핏는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        <NoticeDate>
          이 개인정보처리방침은 2022년 04월 7일부터 적용됩니다.
        </NoticeDate>
      </Wrapper>
    </Container>
  );
